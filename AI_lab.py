# -*- coding: utf-8 -*-
"""
Created on Fri Apr  5 13:31:24 2019
...
def page_read(url):
    ...
    html1 = etree.HTML(r.text)
    print(html1)
    con3 = html1.xpath('//div[contains(@class,"ant-row")]/div/a/text()')
    for item in con3:
        print(item.text)
...
if __name__=='__main__':
    ...
    for i in range(1,2):
        ...
        try:
            ...
            print(e)
    '''
    url='https://www.reagent.com.cn/product/productsort'
    url2='https://www.reagent.com.cn/'
    page_read(url2)
